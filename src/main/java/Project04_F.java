...
public class Project04_F {
    ...
    private static void pdf_maker(List<ExcelVO> data) {
        ...
        try {
            ...
            BaseFont bFont=BaseFont.createFont("NanumGothic.otf", BaseFont.IDENTITY_H, BaseFont.NOT_EMBEDDED);
            ...
            for (String header : headers) {
                ...
                cell.setPhrase(new Phrase(header.toUpperCase(Locale.ROOT), fontHeader));
                table.addCell(cell);
            }
            table.completeRow();
            for (ExcelVO vo : data){
